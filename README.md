...
# Problems
- Only the first artist of a song gets all the other tags. This means if a song is tagged with the genre of "Rap" and only artist #1 will have it correctly categorized. Artist #2 will have every other tag reset back to default.
